  ...
  return createPortal(
    ...
    >
      ...
      >
        {/* Image banner */}
        {hasImage && (
          <div className="relative bg-elevated shrink-0">
            <img
              src={event.image}
              alt={event.title}
            ...
            <button
              ...
              className="absolute bottom-2 right-2 inline-flex items-center gap-1.5 text-2xs font-mono px-2 py-1 rounded-md bg-black/60 text-white hover:bg-black/80 transition-colors backdrop-blur-sm"
            >
              <Maximize2 size={11} />
              Ver imagen
            </button>
        ...
        <div className="flex flex-col overflow-y-auto min-h-0">
          ...
          {/* Actions */}
          <div className="flex flex-col sm:flex-row sm:items-center flex-wrap gap-2 px-5 pt-3 pb-5 border-t border-border mt-3 shrink-0">
              {event.registerUrl && (
                <a
